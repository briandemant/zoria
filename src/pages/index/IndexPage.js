...
export default (
		<DefaultLayout title="Title is fine">
			<div className="card">
			<AdList size="large">
				<AdListItem adId={1234} adUrl="/" adHeader="Ad Header 1234" adDescription="Ad description" adPrice="123,45"/>
				<AdListItem adId={234} adUrl="/" adHeader="Ad Header 234" adDescription="Ad description" adPrice="123,45"/>
				<AdListItem adId={345} adUrl="/" adHeader="Ad Header 345" adDescription="Ad description" adPrice="123,45"/>
				<AdListItem adId={5467} adUrl="/" adHeader="Ad Header 5467" adDescription="Ad description" adPrice="123,45"/>
			</AdList>
			</div>
			<ul>
